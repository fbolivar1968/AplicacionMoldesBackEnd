...
class HerramentalEspecifico(models.Model):
    ...
    piso = models.ForeignKey(Piso, on_delete=models.PROTECT, null=True, blank=True, db_column='hesp_IdPiso')
    estanteria = models.ForeignKey(Estanteria, on_delete=models.PROTECT, null= True, blank= True, db_column='hesp_IdEstanteria', related_name='herramentales_especificos') # Relación con Estanteria, con un valor por defecto (ajustar según necesidad)
    ubicacion_herr = models.ForeignKey(UbicacionHerramental, on_delete=models.PROTECT, null=True, blank=True, db_column='hesp_IdUbicacionHerr')
